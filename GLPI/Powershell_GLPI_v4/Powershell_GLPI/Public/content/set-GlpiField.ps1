...
.EXAMPLE
PS C:\> set-GlpiField -session $session.session_token -apptoken $apptoken -ItemID $ItemID -fieldTitle $fieldTitle  -fieldValue $fieldValue
.INPUTS
.OUTPUTS
#>
function set-GlpiField (){
    ...
    $uri = "$GlpiUri/apirest.php/Ticket/$($ItemID)"
